...
function SubCategories() {
  return (
    <section className="mt-20 container px-4 mx-auto">
      <h2 className="text-lg font-medium text-gray-800 dark:text-white">Sous Categories</h2>

      <p className="mt-1 text-sm text-gray-500 dark:text-gray-300">Ajouter et modifier la liste des sous categories.</p>

      <div className='mt-5'>
        <label htmlFor="categorie" className="block text-sm text-gray-500 dark:text-gray-300">Ajouter sous categorie</label>
        ...
        <div className="flex">
          <input type="text" placeholder="Exemple electronique" className="rounded-r-none  block w-full placeholder-gray-400/70 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
          <button className="rounded-l-none flex items-center px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">

            <svg className="w-5 h-5 mx-1" fill="#ffffff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45.402 45.402" >
                ...
                <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                  <tr>
                    <td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
                      <div>
                        <h2 className="font-medium text-gray-800 dark:text-white ">Electronique</h2>
